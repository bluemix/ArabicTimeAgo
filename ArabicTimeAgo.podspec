...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ArabicTimeAgo.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/ArabicTimeAgo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Abdulmomen Kadum عبدالمؤمن كاظم' => 'a.bluemix@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/ArabicTimeAgo.git', :tag => s.version.to_s }
